...
TABLE_NAME='STOCKS'
DELETE_ROWS=10000
BACKUP_TAG='STABLE_YEARLY_BU' # Tag used in your YEARLY backup script
...
echo "========================================================================" | tee -a $LOG_FILE
echo "Starting YEARLY Backup Restore Simulation at $(date)" | tee -a $LOG_FILE
...
RUN {
    ...
    # 2. Restore the full database using the specified yearly backup TAG.
